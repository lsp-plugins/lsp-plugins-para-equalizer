...
namespace lsp
{
    namespace plugins
    {
        ...
        inline void para_equalizer::decode_filter(uint32_t *ftype, uint32_t *slope, size_t mode)
        {
            ...
            switch (*ftype)
            {
                ...
                case EQF(ALLPASS):
                {
                    switch (mode)
                    {
                        EQS(RLC_BT, FLT_BT_RLC_ALLPASS, 2)
                        EQS(RLC_MT, FLT_BT_RLC_ALLPASS, 2)
        ...
        void para_equalizer::init(plug::IWrapper *wrapper, plug::IPort **ports)
        {
            ...
            vFreqs              = advance_ptr<float>(abuf, meta::para_equalizer_metadata::MESH_POINTS);
        ...
        uint32_t para_equalizer::calc_decramping()
        {
